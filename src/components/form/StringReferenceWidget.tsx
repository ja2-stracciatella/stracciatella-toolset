...
export function StringReferenceWidget({ value, onChange, required, referenceFile, referenceProperty }: StringReferenceWidgetProps) {
...
export function stringReferenceTo(file: string, property: string) {
    return (props: WidgetProps) => <StringReferenceWidget referenceFile={file} referenceProperty={property} {...props} />;
}